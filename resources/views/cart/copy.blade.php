              ...
              <div class="row mb-4">
                ...
                <h5 style="color: grey;">Supplements :</h5 >
                  ...
                  <h5 style="color: grey;">Shipping details :</h5 >
                    <div class="content">
                      <form method="post" id="payment-form" action=" {{route('checkout.validate')}} " style="color: black">
                          @csrf
                          <div class="row">
                            <div class="col-md-8">
                ...
                <div class="card-body">
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                      ...
                      <span class="supplement-price"><strong>MAD</strong></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                        <div>
                          <strong>Tax</strong>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                                    ...
                                    <label for="amount" style="display:inline-flex; text-align:right">
                                        ...
                                        <div class="input-wrapper amount-wrapper">
                                            <input id="amount" name="amount" type="tel" style="border:transparent;margin-left:50px" disabled value={{Cart::total()}}>
                                        </div>
                                    </label>  
                                </li>
