				...
				<div class="col-lg-4 d-flex ftco-animate">
    				...
    				<div class="services-wrap d-flex">
    					...
    					<div class="text p-4">
    						...
    						<p class="price"><span>{{$product->price}}MAD</span> <a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
				@endforeach
      ...
      <div class="container">
		...
		@foreach($formules as $formule)
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="#" class="block-20" style="background-image: url('{{$formule->imagePath}}');">
              </a>
              <div class="text py-4 d-block">
                <h3 class="heading mt-2"><a href="#">{{$formule->name}}</a></h3>
                {{$formule->description}}
              </div>
            </div>
          </div>
